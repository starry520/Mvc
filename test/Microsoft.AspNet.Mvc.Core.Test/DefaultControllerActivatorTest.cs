...
namespace Microsoft.AspNet.Mvc.Core.Test
{
    public class DefaultControllerActivatorTest
    {
        ...
        public void Activate_SetsBindingContext()
        {
            ...
            var services = GetServices();
            services.GetRequiredService<IContextAccessor<ActionBindingContext>>().SetValue(bindingContext);
        ...
        private IServiceProvider GetServices()
        {
            ...
            services
                .Setup(s => s.GetService(typeof(IContextAccessor<ActionBindingContext>)))
                .Returns(new MockActionBindingContextAccessor());
